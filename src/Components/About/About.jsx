          ...
          <div className='about-des w-full pt-5'>
            ...
            <div className='about-we w-full md:flex md:justify-between py-5 items-center  '>
              ...
              <div className='md:w-1/2'>
                ...
                <p className='font-semibold md:text-xl  text-justify'>At Chennai Digital Prints, we specialize in delivering top-notch printing solutions tailored to meet your needs. Whether you're looking for vibrant business cards, eye-catching posters, or personalized banners, we've got you covered. Our dedicated team utilizes state-of-the-art technology to ensure crisp, high-quality prints every time. From concept to completion, we're committed to exceeding your expectations and bringing your vision to life. Experience the difference with Chennai Digital Prints.</p>
              </div>
            </div>
            {/* SECOND SECTION */}
            <div className='md:flex w-full items-center py-5 justify-between'>
              <div className='what-text  order-2 md:order-1  md:w-1/2'>
                ...
                <p className='font-semibold md:text-xl text-justify'>Chennai Digital Prints is more than just a printing company - we're your trusted partner in bringing your ideas to life. Since 2006, we've been dedicated to providing exceptional printing services that exceed expectations. With a focus on quality, affordability, and customer satisfaction, we strive to be your go-to destination for all your printing needs. Our experienced team is passionate about delivering excellence in every project, ensuring that your vision is realized with precision and care. Discover the Chennai Digital Prints difference today.</p>
              </div>
            ...
            <div className='customer py-5'>
              ...
              <p className='font-semibold md:text-xl text-justify md:text-center md:w-1/2 mx-auto'>Customer satisfaction isn't just a goal; it's our guiding principle. With our unwavering commitment, we guarantee your utmost satisfaction. Our dedicated team stands ready to address any inquiries, fulfill requests, or resolve concerns promptly. Every interaction with us is designed to be seamless and enjoyable because exceeding your expectations is our priority. Discover the unparalleled experience offered by Chennai Digital Prints, where excellence in quality, affordability, and customer satisfaction converge to meet all your printing needs.</p>
            </div>
            {/* Marquee space  */}
            <div className='py-5'>
